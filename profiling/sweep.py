    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "set +a",
            "",
            "export STABLE_DATASETS_CACHE_DIR=$HOME/scratch/stable-datasets-iclr",
            "export HF_HOME=$HOME/scratch/stable-datasets-iclr/huggingface",
            "export HF_DATASETS_CACHE=$HOME/scratch/stable-datasets-iclr/huggingface/datasets",
            "",
            command,
            "",
        ]
