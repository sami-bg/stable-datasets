...
class Cars196(BaseDatasetBuilder):
    ...
    SOURCE = DatasetSource(
        ...
        assets={
            "train": DownloadInfo(
                url="https://huggingface.co/datasets/haodoz0118/cars196-img/resolve/main/cars196_train.zip"
            ),
            "test": DownloadInfo(
                url="https://huggingface.co/datasets/haodoz0118/cars196-img/resolve/main/cars196_test.zip"
            ),
        },
