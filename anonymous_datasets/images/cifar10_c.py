...
from anonymous_datasets.schema import ClassLabel, DatasetInfo, DatasetSource, DownloadInfo, Features, Value, Version
...
class CIFAR10C(BaseDatasetBuilder):
    ...
    SOURCE = DatasetSource(
        ...
        assets={
            "test": DownloadInfo(url="https://zenodo.org/records/2535967/files/CIFAR-10-C.tar?download=1"),
        },
