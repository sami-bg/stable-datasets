...
from anonymous_datasets.images.imagenet_1k import ImageNet1K
from anonymous_datasets.images.imagenet_10 import Imagenette
from anonymous_datasets.images.imagenet_100 import ImageNet100
...
def test_imagenet_1k_streaming_integration(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("anonymous_datasets.images.imagenet_1k.download", lambda *args, **kwargs: tar_path)
...
def test_imagenet_100_streaming_integration(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("anonymous_datasets.images.imagenet_100.download", lambda *args, **kwargs: tar_path)
...
def test_imagenet_10_integration(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("anonymous_datasets.images.imagenet_10.download", lambda *args, **kwargs: tar_path)
