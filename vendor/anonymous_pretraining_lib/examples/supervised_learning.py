...
def get_data_loaders(cfg):
    ...
    train_loader = torch.utils.data.DataLoader(
        ...
        sampler=apl.data.sampler.RepeatedRandomSampler(
...
def main(cfg: dict):
    ...
    data_module = apl.data.DataModule(train=train_loader, val=val_loader)
    ...
    backbone = apl.backbone.utils.set_embedding_dim(
    ...
    linear_probe_proj = apl.callbacks.OnlineProbe(
    ...
    manager = apl.Manager(trainer=trainer, module=module, data=data_module)
    manager()
    manager.validate()
