"""This script demonstrates how to retrieve data from wandb using the anonymous_pretraining_lib library and create plots from it.
...
configs, dfs = apl.reader.wandb_project(
...
for run_id, df in tqdm(dfs.items(), desc="Processing runs", unit="run"):
    ...
    if (
        ...
        if (
            ...
            new_df, config = apl.reader.wandb(entity, project, run_id)
