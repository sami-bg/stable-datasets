...
class TestMNISTUnit:
    ...
    def test_dictconfig_structure(self):
        ...
        assert data_config._target_ == "anonymous_pretraining_lib.data.DataModule"
    ...
    def test_manager_initialization_with_dictconfig(self):
        ...
        with patch("anonymous_pretraining_lib.Manager") as mock_manager:
    ...
    def test_datamodule_dict_initialization(self):
        ...
        with patch("anonymous_pretraining_lib.data.DataModule") as mock_datamodule:
    ...
    def test_resnet9_initialization(self):
        ...
        with patch("anonymous_pretraining_lib.backbone.Resnet9") as mock_resnet:
