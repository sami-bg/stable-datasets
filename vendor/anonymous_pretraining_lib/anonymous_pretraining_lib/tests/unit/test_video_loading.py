...
class TestVideoLoadingUnit:
    ...
    def test_video_to_image_transform(self):
        ...
        with patch("anonymous_pretraining_lib.data.transforms.ToImage") as mock_to_image:
            mock_to_image(
                scale=False,
                mean=[0, 0, 0],
                std=[255, 255, 255],
    ...
    def test_image_to_video_encoder_initialization(self):
        ...
        with patch("anonymous_pretraining_lib.utils.ImageToVideoEncoder") as mock_encoder:
