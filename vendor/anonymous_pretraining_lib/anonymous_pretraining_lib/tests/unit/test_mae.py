...
class TestMAEUnit:
    ...
    def test_mae_backbone_initialization(self):
        ...
        with patch(
            "anonymous_pretraining_lib.backbone.mae.vit_base_patch16_dec512d8b"
        ) as mock_mae:
            backbone = mock_mae()
    ...
    def test_mae_loss_function(self):
        ...
        with patch("anonymous_pretraining_lib.losses.mae") as mock_mae_loss:
    ...
    def test_repeated_random_sampler(self):
        ...
        with patch(
            "anonymous_pretraining_lib.data.sampler.RepeatedRandomSampler"
        ) as mock_sampler:
            mock_dataset = Mock()
