...
class TestProbingUnit:
    ...
    def test_online_probe_initialization(self):
        ...
        with patch("anonymous_pretraining_lib.callbacks.OnlineProbe") as mock_probe:
    ...
    def test_online_knn_initialization(self):
        ...
        with patch("anonymous_pretraining_lib.callbacks.OnlineKNN") as mock_knn:
            mock_metrics = Mock(spec=torchmetrics.classification.MulticlassAccuracy)
    ...
    def test_eval_only_wrapper(self):
        ...
        with patch("anonymous_pretraining_lib.backbone.EvalOnly") as mock_eval_only:
            mock_backbone = Mock()
    ...
    def test_transform_composition(self):
        ...
        with patch("anonymous_pretraining_lib.data.transforms") as mock_transforms:
    ...
    def test_module_without_optimizer(self):
        ...
        with patch("anonymous_pretraining_lib.Module") as mock_module:
            mock_backbone = Mock()
            mock_forward = Mock()
    ...
    def test_online_probe_lifecycle_methods(self):
        ...
        from anonymous_pretraining_lib.callbacks import OnlineProbe
