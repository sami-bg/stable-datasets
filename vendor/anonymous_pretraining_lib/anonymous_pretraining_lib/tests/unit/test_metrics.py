...
class TestMetricsFormatter:
    ...
    def test_format_dict_metrics(self):
        ...
        result = anonymous_pretraining_lib.callbacks.utils.format_metrics_as_dict(metrics)
    ...
    def test_format_single_metric(self):
        ...
        result = anonymous_pretraining_lib.callbacks.utils.format_metrics_as_dict(metric)
        from torch.nn import ModuleDict
    ...
    def test_format_nested_metrics(self):
        ...
        result = anonymous_pretraining_lib.callbacks.utils.format_metrics_as_dict(nested)
        from torch.nn import ModuleDict
