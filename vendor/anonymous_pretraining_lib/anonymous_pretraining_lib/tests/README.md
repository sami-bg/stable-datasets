# anonymous-pretraining-lib Test Suite
...
python -m pytest anonymous_pretraining_lib/tests/unit/test_transforms.py
python -m pytest anonymous_pretraining_lib/tests/integration/test_transforms.py

# Run with coverage
python -m pytest --cov=anonymous_pretraining_lib -m unit
```
...
import pytest
import torch
import anonymous_pretraining_lib as ossl
...
```yaml
- name: Run Unit Tests
  run: python -m pytest anonymous_pretraining_lib/ -m unit --verbose --cov=anonymous_pretraining_lib
```
