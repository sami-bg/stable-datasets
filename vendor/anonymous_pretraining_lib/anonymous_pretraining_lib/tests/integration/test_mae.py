...
class TestMAEIntegration:
    ...
    def test_mae_with_probing(self):
        ...
        backbone = apl.backbone.mae.vit_base_patch16_dec512d8b()
    ...
    def test_mae_reconstruction_loss(self):
        ...
        loss = apl.losses.mae(patches, pred, mask)
    ...
    def test_mae_patchify_unpatchify(self):
        ...
        from anonymous_pretraining_lib.backbone.mae import PatchEmbed
    ...
    def test_mae_multi_view_sampling(self):
        ...
        from anonymous_pretraining_lib.data.sampler import RepeatedRandomSampler
