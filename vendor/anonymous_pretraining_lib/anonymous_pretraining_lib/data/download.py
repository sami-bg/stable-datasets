...
def bulk_download(
    ...
    cache_dir: str = "~/.anonymous_pretraining_lib/",
):
    """Download multiple files concurrently.

    Example:
        import anonymous_pretraining_lib
        anonymous_pretraining_lib.data.bulk_download([
            "XXXX",
            "XXXX",
        ], "todelete")
    ...
    Args:
        ...
        cache_dir (str, optional): Cache directory path. Defaults to "~/.anonymous_pretraining_lib/".
    """
...
def download(
    ...
    dest_folder,
    backend="filesystem",
    cache_dir="~/.anonymous_pretraining_lib/",
    progress_bar=True,
    _progress_dict=None,
    _task_id=None,
):
